 ...
 * the SSSE (Sub Set of Set Extension) tactic, such as the tactic name and other 
 * parameters of the expression to be analized.
 *
 */
public class SSSETacticInfo extends TacticInfo{

	private Expr leftExpr;
	private SetExpr setExpr; 

	/**
	* Creates instances of SSSETacticInfo.
	*/
	public SSSETacticInfo()
	{
		super.setTacticName("SSSE");
	}	
