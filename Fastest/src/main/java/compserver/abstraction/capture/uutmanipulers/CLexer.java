...
public class CLexer extends Lexer {
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:507:2: ( LETTER ( LETTER | '0' .. '9' )* )
            // C.g:507:4: LETTER ( LETTER | '0' .. '9' )*
            {
            mLETTER(); 
            // C.g:507:11: ( LETTER | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mCHARACTER_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:519:5: ( '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\'' )
            // C.g:519:9: '\\'' ( EscapeSequence | ~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 
            // C.g:519:14: ( EscapeSequence | ~ ( '\\'' | '\\\\' ) )
            int alt2=2;
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:523:5: ( '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"' )
            // C.g:523:8: '\"' ( EscapeSequence | ~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 
            // C.g:523:12: ( EscapeSequence | ~ ( '\\\\' | '\"' ) )*
            loop3:
            do {
                int alt3=3;
    ...
    public final void mHEX_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:526:13: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // C.g:526:15: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
    ...
    public final void mDECIMAL_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:528:17: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // C.g:528:19: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            // C.g:528:19: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt7=2;
    ...
    public final void mOCTAL_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:530:15: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // C.g:530:17: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            // C.g:530:21: ( '0' .. '7' )+
            int cnt9=0;
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // C.g:533:10: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // C.g:533:12: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
    ...
    public final void mFLOATING_POINT_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:542:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix )
            int alt25=4;
            alt25 = dfa25.predict(input);
            switch (alt25) {
                case 1 :
                    // C.g:542:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    // C.g:542:9: ( '0' .. '9' )+
                    int cnt14=0;
                    loop14:
                ...
                case 3 :
                    ...
                    break;
                case 4 :
                    // C.g:545:9: ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix
                    {
                    // C.g:545:9: ( '0' .. '9' )+
                    int cnt23=0;
                    loop23:
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // C.g:556:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | OctalEscape )
            int alt28=2;
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // C.g:562:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt29=3;
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // C.g:569:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // C.g:569:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
            match('u'); 
            mHexDigit(); 
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // C.g:576:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // C.g:576:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // C.g:576:14: ( options {greedy=false; } : . )*
            loop30:
            do {
                int alt30=2;
    ...
    class DFA25 extends DFA {
        ...
        public String getDescription() {
            return "541:1: FLOATING_POINT_LITERAL : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ ( Exponent )? FloatTypeSuffix );";
        }
    }
