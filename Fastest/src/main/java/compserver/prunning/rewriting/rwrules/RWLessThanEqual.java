...
public class RWLessThanEqual implements RWRuleOperator{
	public RWLessThanEqual(){
		operator = "\\leq";
	}
	...
	public String rewrite(String originalExpr){
		...
		String operands[] = strTerm.split("leq ");
		...
		String oldExpr = leftOperand+" \\\\leq "+rightOperand;
		String newExpr = rightOperand+" \\\\geq "+leftOperand; 
