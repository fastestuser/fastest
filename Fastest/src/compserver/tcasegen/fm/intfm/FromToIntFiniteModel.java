 ...
 */
public class FromToIntFiniteModel implements IntFiniteModel{
     ...
     * @param arrayList
     */
    public FromToIntFiniteModel(List<BigInteger> arrayList){
	...
	public Object clone(){
        ...
        IntFiniteModel intFiniteModel = new FromToIntFiniteModel(auxArrayList);
