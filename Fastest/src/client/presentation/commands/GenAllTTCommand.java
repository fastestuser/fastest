...
public class GenAllTTCommand implements Command {
	...
	public void run(ClientTextUI clientTextUI, String args) {
		...
		try {
			...
			Iterator<Map.Entry<String, List<Tactic>>> tacticIterator = tacticSet.iterator();
			while (tacticIterator.hasNext()) {
				...
				boolean isOp = FastestUtils.isLoadedOperation(controller,opNameOrTClassName);
				...
				if (isOp) {
					...
					tTreeStrategy = opTTreeStrategyMap.get(FastestUtils.getOpAssociated(controller,opNameOrTClassName));
				}
