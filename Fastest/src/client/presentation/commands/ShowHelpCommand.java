...
public class ShowHelpCommand implements Command{ 
	...
	public void run(ClientTextUI clientTextUI, String args){
		...
		out.println("loadrefrule <file_name>");
		out.println("\tReads a file containing FTCRL programs.\n");
	...
	out.println("\tGenerates the test cases for every selected operation.\n");
		...
		out.println("showctc <name>|<all> [-o <target_folder>]");
		out.println("\tShows the specified (or all) refinement test case, <name> could be a tree node, an operation schema or a concrete test case." +
				" A previously calling to showtt would be helpful .\n");
		
		out.println("refine <name> to test <path> implemented in <pl> with <frr>");
		out.println("\tRefine the Z operation pecified by <name>. <path> is the UUT." +
				" <pl> is the program language target. <frr> is the name oh a refinement rule.\n");
