 ...
 * whose test class children will be pruned.
 * @author Pablo Rodriguez Monetti
 */
public class PruneBelowCommand implements Command {
    ...
    public void run(ClientTextUI clientTextUI, String args) {
        ...
        try {
            ...
            boolean result = (new TreePruner(controller)).pruneBelow(tClassName);
