...
public interface FTCRLListener extends ParseTreeListener {
	void enterRefinement(FTCRLParser.RefinementContext ctx);
	void exitRefinement(FTCRLParser.RefinementContext ctx);

	void enterZExprSet(FTCRLParser.ZExprSetContext ctx);
	void exitZExprSet(FTCRLParser.ZExprSetContext ctx);
	...
	void enterFName(FTCRLParser.FNameContext ctx);
	void exitFName(FTCRLParser.FNameContext ctx);

	void enterReference2(FTCRLParser.Reference2Context ctx);
	void exitReference2(FTCRLParser.Reference2Context ctx);
	...
	void enterName(FTCRLParser.NameContext ctx);
	void exitName(FTCRLParser.NameContext ctx);

	void enterPreamble(FTCRLParser.PreambleContext ctx);
	void exitPreamble(FTCRLParser.PreambleContext ctx);
	...
	void enterDataStruct(FTCRLParser.DataStructContext ctx);
	void exitDataStruct(FTCRLParser.DataStructContext ctx);

	void enterAsSynonym(FTCRLParser.AsSynonymContext ctx);
	void exitAsSynonym(FTCRLParser.AsSynonymContext ctx);

	void enterUut(FTCRLParser.UutContext ctx);
	void exitUut(FTCRLParser.UutContext ctx);
	...
	void enterNumber(FTCRLParser.NumberContext ctx);
	void exitNumber(FTCRLParser.NumberContext ctx);
	...
	void enterLawName(FTCRLParser.LawNameContext ctx);
	void exitLawName(FTCRLParser.LawNameContext ctx);
	...
	void enterEnumeration(FTCRLParser.EnumerationContext ctx);
	void exitEnumeration(FTCRLParser.EnumerationContext ctx);

	void enterZExprNum(FTCRLParser.ZExprNumContext ctx);
	void exitZExprNum(FTCRLParser.ZExprNumContext ctx);

	void enterSName(FTCRLParser.SNameContext ctx);
	void exitSName(FTCRLParser.SNameContext ctx);

	void enterRefinementLaw(FTCRLParser.RefinementLawContext ctx);
	void exitRefinementLaw(FTCRLParser.RefinementLawContext ctx);
}