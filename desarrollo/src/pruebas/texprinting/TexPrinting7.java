...
// INTENTA imprimir desde el AxPara con LatexString creando una nueva estructura que lo envuelva - Y PASANDOLE el OpTable y LatexmarkUpTable (Viene de TexPrinting6) NO FUNCIONA!
public class TexPrinting7{
...
/*
			...
			OpTable opTable = (OpTable) 
				manager.get(new Key(source.getName(), OpTable.class));
...
*/
	...
	public static void processAxPara(AxPara axPara){
		...
		manager.put(new Key("Specification", LatexMarkupFunction.class), new LatexMarkupFunction("Specification"));
