...
class NodeArray extends NodeType {
    ...
    private     NodeType        type;
    private     int                     size;
    private String lastPositionPointer;
    ...
    NodeArray(NodeType nodeType, int size, String lastPositionPointer)
    {
        this.type = nodeType;
        this.size = size;
    ...
    public void setLastPosPointerID(String lastPositionPointer){
        this.lastPositionPointer = lastPositionPointer;
    }
}
//********************************************************************************
...
class NodeList extends NodeType{
    ...
    // Constructor for Java Languaje
    NodeList(String id, String lT, NodeType type)
    {
        name = id;
        listType = lT;
        nodeType = type;
...
//********************************************************************************
  final public TCRL_AST parse() throws ParseException {
  String                lawName;
  String                preamble;
  NodeRules             rules;
  String                epilogue;
...
//********************************************************************************
  final public String LawName() throws ParseException {
  Token name;
 ...
 //********************************************************************************
  final public String Preamble() throws ParseException {
  Token plCode;
...
//********************************************************************************
  final public String Epilogue() throws ParseException {
  Token plCode;
...
//********************************************************************************
  final public NodeRules Rules() throws ParseException {
    NodeRule    rule;
...
//********************************************************************************
  final public NodeRule Rule() throws ParseException {
  NodeRule nodeRule;
    if (jj_2_2(3)) {
...
//********************************************************************************
  final public RuleSynonym RuleSynonym() throws ParseException {
    Token id;
    NodeType nodeType;
...
//********************************************************************************
  final public RuleRefinement RuleRefinement() throws ParseException {
...
//********************************************************************************
  final public ArrayList<String> SpecIDS() throws ParseException {
   Token specID;
...
//********************************************************************************
  final public Abstraction Abstraction() throws ParseException {
...
//********************************************************************************
  final public NodeType Type() throws ParseException {
    NodeType nodeType;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SYNONYM:
      nodeType = Synonym();
...
//********************************************************************************
  final public NodeSynonym Synonym() throws ParseException {
    Token id;
...
//********************************************************************************
  final public NodePLType PLType() throws ParseException {
    Token id;
...
//********************************************************************************
  final public NodeEnumeration Enumeration() throws ParseException {
    NodePLType                                  plType;
...
//********************************************************************************
  final public NodePointer Pointer() throws ParseException {
    NodeType type;
...
//********************************************************************************
  final public NodeArray Array() throws ParseException {
    NodeType type;
    Token s = null;
    Token lastPositionPointer = null;
    ...
    if (jj_2_5(2)) {
      jj_consume_token(COMMA);
      lastPositionPointer = jj_consume_token(ID);
    } else {
      ;
    }
    jj_consume_token(RBRACKET);
        Integer size = new Integer(s.image);
        if(lastPositionPointer==null)
                {if (true) return new NodeArray(type, size.intValue());}
        else
                {if (true) return new NodeArray(type, size.intValue(), lastPositionPointer.image);}
    throw new Error("Missing return statement in function");
  }

//********************************************************************************
  final public NodeStructure Structure() throws ParseException {
...
//********************************************************************************
  final public NodeList List() throws ParseException {
    List<NodeElement> elements = new ArrayList<NodeElement>();
    Token id = null;
    Token linkType = null, listNext = null, listPrevius = null, mem = null;
    Token listType=null;
    NodeType type = null;
    NodeElement element;
    ...
    case DCLL:
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case SLL:
        linkType = jj_consume_token(SLL);
        jj_consume_token(COMMA);
        listNext = jj_consume_token(ID);
        break;
      case DLL:
        linkType = jj_consume_token(DLL);
        jj_consume_token(COMMA);
        listNext = jj_consume_token(ID);
        jj_consume_token(COMMA);
        listPrevius = jj_consume_token(ID);
        break;
      case CLL:
        linkType = jj_consume_token(CLL);
        jj_consume_token(COMMA);
        listNext = jj_consume_token(ID);
        break;
      case DCLL:
        linkType = jj_consume_token(DCLL);
        jj_consume_token(COMMA);
        listNext = jj_consume_token(ID);
        jj_consume_token(COMMA);
        listPrevius = jj_consume_token(ID);
      ...
      break;
    case STRING:
      listType = jj_consume_token(STRING);
      jj_consume_token(COMMA);
      type = Type();
      break;
    default:
    ...
    jj_consume_token(RBRACKET);
        if (listType==null)
                ...
                {if (true) return new NodeList(id.image,listType.image.substring(1,listType.image.length()-1),type);}
    jj_consume_token(RBRACKET);
    throw new Error("Missing return statement in function");
  }

//********************************************************************************
  final public NodeFile File() throws ParseException {
...
//********************************************************************************
  final public NodeDB DB() throws ParseException {
...
//********************************************************************************
  final public String columnType() throws ParseException {
    Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
...
//********************************************************************************
  final public NodeRFR RFR() throws ParseException {
  ...
  public TCRL_ParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x230fe000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf00000,0x0,0xf00000,0x1c000000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x2000,0x10,0x2000,0x10,0x1000,0x2000,0x1000,0x2000,0x1000000,0x1000000,0x1e000000,0x0,0x2000,0x2000,0x1000,0x2000,0x2000,0x2000,0x2000,0x2000,0x2000,0x2000,0x2000,0x1000,0x2000,0x2000,0x2000,0x1000,0x2000,0x2000,0x0,0x1000,0x4000,0x0,0x1000,0x7,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
