 ...
 * generator for the integer type is the one that forms the finite model with the values
 * zero.
 * @author Pablo Rodriguez Monetti
 */
public class ZeroIntFiniteModelParser implements IntFiniteModelParser{
