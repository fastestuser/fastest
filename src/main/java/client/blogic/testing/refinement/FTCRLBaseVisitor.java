...
public class FTCRLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements FTCRLVisitor<T> {
	...
	@Override public T visitName(FTCRLParser.NameContext ctx) { return visitChildren(ctx); }

	@Override public T visitPreamble(FTCRLParser.PreambleContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitIExprRefinement(FTCRLParser.IExprRefinementContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitDataStruct(FTCRLParser.DataStructContext ctx) { return visitChildren(ctx); }

	@Override public T visitAsSynonym(FTCRLParser.AsSynonymContext ctx) { return visitChildren(ctx); }

	@Override public T visitUut(FTCRLParser.UutContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitLawName(FTCRLParser.LawNameContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitEnumeration(FTCRLParser.EnumerationContext ctx) { return visitChildren(ctx); }

	@Override public T visitZExprNum(FTCRLParser.ZExprNumContext ctx) { return visitChildren(ctx); }

	@Override public T visitSName(FTCRLParser.SNameContext ctx) { return visitChildren(ctx); }

	@Override public T visitRefinementLaw(FTCRLParser.RefinementLawContext ctx) { return visitChildren(ctx); }
}