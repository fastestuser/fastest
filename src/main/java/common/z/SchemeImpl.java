...
/**
 * An implementation of the interface Scheme.
...
public class SchemeImpl implements Scheme{
	...
	public SchemeImpl(AxPara axPara)
	...
	public static boolean isScheme(AxPara axPara){
		return (axPara.getBox().equals(Box.SchBox));
	}
    ...
    @Override
	public AxPara clone(){
		return new SchemeImpl((AxPara)myAxPara.accept(new CZTCloner()));
	}
}
