...
// Parseamos una especificacion schEvalTest2.tex cuyo unico esquema tiene el predicado a = {}. Obtenemos el predicado y reemplazamos las 
//ocurrencias de f por {5} obteniendo {5}={}, lo evaluamos y el resultado NO es correcto. Lanza una UndeterminedtypeException. Pero como
//le agregamos el chequeo de tipos (respecto a SchemeEvaluatorTest2) evalua correctamente a false.


// O parseamos una especificacion schEvalTest3.tex cuyo unico esquema tiene el predicado a = {5}. Obtenemos el predicado y reemplazamos la ocurrencia de a por {5}, obteniendo {5}={5}, lo evaluamos y el resultado es correcto, true.

public class SchemeEvaluatorTest4{
					...
					if (paraList instanceof ZParaList) {
						...
						for(int i=0; i < zParaList.size(); i++){
							...
							if (para instanceof AxPara){
								...
								Expr expr2 = (Expr)textUI.parseTerm("\\{5\\}", new PrintWriter(System.out, true));
								...
								System.out.println("El predicado con el reemplazo, y que se va a evaluar es: ");
								System.out.println(textUI.printTerm(newPred, Markup.LATEX));
								CztPrinter.printPred(newPred,1);
