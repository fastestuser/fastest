...
public class RWGreaterThanEqual implements RWRuleOperator{
	public RWGreaterThanEqual(){
		operator = "\\geq";
	}
	...
	public String rewrite(String originalExpr){
		...
		String operands[] = strTerm.split("geq ");
		...
		String oldExpr = leftOperand+" \\\\geq "+rightOperand;
		String newExpr = rightOperand+" \\\\leq "+leftOperand; 
