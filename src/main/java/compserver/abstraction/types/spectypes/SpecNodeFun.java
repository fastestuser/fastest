 ...
 * the information of type of a total function
 */
public class SpecNodeFun implements SpecNodeBinRelation{

	public SpecNodeFun(){
	}
	public SpecNodeFun(SpecNode domType, SpecNode ranType){
